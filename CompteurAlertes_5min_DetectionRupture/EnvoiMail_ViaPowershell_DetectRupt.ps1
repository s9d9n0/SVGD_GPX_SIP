...
$sujet = "Detection Rupture"

$pj1 = "C:\Users\SIAR_ycg8l6\Docs\ProgrammesR\CompteurAlertes_5min_DetectionRupture\df_regroup.csv"
$pj2 = "C:\Users\SIAR_ycg8l6\Docs\ProgrammesR\CompteurAlertes_5min_DetectionRupture\df_delta_group.csv"
