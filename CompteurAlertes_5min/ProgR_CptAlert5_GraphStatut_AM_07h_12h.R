...
png(file="graph_OsnyStatus.png",width = 650, height = 500)
graph_Osny
dev.off()
png(file="graph_OsnyZone.png",width = 650, height = 500)
graph_ZoneOsny
dev.off()

png(file="graph_AuzeStatus.png",width = 650, height = 500)
graph_Auzeville
dev.off()
png(file="graph_AuzeZone.png",width = 650, height = 500)
graph_ZoneAuzeville
dev.off()
...
file.copy(from=paste0(chemin_graph,"/Graph_Chronogrammes_",date_ref,".zip"),
          to=paste0(chemin_graph,"/Graph_Chronogrammes_jour_midi.zip"))
...
system('powershell -file "C:\\Users\\SIAR_ycg8l6\\Docs\\ProgrammesR\\CompteurAlertes_5min\\EnvoiMail_ViaPowershell_Graph_12h15.ps1"')

# suppression du fichier .zip envoye...
file.remove(paste0(chemin_graph,"/Graph_Chronogrammes_jour_midi.zip"))
