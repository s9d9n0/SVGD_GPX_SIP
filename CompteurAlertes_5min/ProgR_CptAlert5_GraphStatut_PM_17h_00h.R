...
file.copy(from=paste0(chemin_graph,"/Graph_Chronogrammes_",date_ref,".zip"),
          to=paste0(chemin_graph,"/Graph_Chronogrammes_jour_nuit.zip"))
...
system('powershell -file "C:\\Users\\SIAR_ycg8l6\\Docs\\ProgrammesR\\CompteurAlertes_5min\\EnvoiMail_ViaPowershell_Graph_00h15.ps1"')

# suppression du fichier .zip envoye...
file.remove(paste0(chemin_graph,"/Graph_Chronogrammes_jour_nuit.zip"))
